...
public class ContainerEntityHopper extends Container
{
	private final IInventory hopperInventory;

    public ContainerEntityHopper(InventoryPlayer playerInventory, IInventory hopperInventoryIn, EntityPlayer player)
    {
