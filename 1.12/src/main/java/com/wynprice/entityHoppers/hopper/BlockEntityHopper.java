...
import com.wynprice.entityHoppers.References;
...
public class BlockEntityHopper extends BlockContainer
{
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityEntityHopper)tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tileentity instanceof TileEntityEntityHopper)
        {
            InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityEntityHopper)tileentity);
